...
private ProductCategoryRepository productCategoryRepository;
    ...
    public ResultResponse queryList() {
        ...
        //获取类目编号的集合
        List<Integer> typeList=productCategoryDtoList.stream().map(productCategoryDto ->
        ...
        //过滤：不同的type进行不同的封装
        //将productInfo转成Dto
        List<ProductCategoryDto> productCategoryDtos = productCategoryDtoList.parallelStream()
